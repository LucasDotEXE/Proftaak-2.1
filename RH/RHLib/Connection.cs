...
namespace RHLib
{
    ...
    public abstract class Connection
    {
        ...
        // connection
        protected void startConnection(bool isDocter, string host = Config.host, int port = Config.port, string name = Config.serverName)
        {
            ...
            try
            {
                ...
                this.stream.AuthenticateAsClient(name);
